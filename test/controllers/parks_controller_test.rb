...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { address_line_1: @park.address_line_1, address_line_2: @park.address_line_2, avatar: @park.avatar, cover: @park.cover, description: @park.description, images: @park.images, name: @park.name, post_code: @park.post_code } }
    end
